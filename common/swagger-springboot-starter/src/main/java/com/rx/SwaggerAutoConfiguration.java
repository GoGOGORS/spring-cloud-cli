...
/**
 * {@code @author: jsf}
 * {{@code @Date} @date: 2022-07-28 11:28}
...
public class SwaggerAutoConfiguration {
    ...
    public List<Docket> createRestApi(SwaggerProperties swaggerProperties) {
        ...
        // 没有分组
        if (swaggerProperties.getDockets().size() == 0) {
        ...
        // 分组创建
        for (String groupName : swaggerProperties.getDockets().keySet()) {
            SwaggerProperties.DocketInfo docketInfo = swaggerProperties.getDockets().get(groupName);
